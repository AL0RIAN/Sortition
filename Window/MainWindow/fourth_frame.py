...
class FourthElement(tk.Frame):
    ...
    def make_column(self, gender, age, weight, number_cycle, number_field, n_column):
        for i in range(number_cycle):
            ...
            try:
                athlete = tk.Label(self, text=TREE[n_column][gender][age][weight][i // 2][flag]["name"], bg="#DCF4FF")
            except TypeError:
                athlete = tk.Label(self, text=TREE[n_column][gender][age][weight][i // 2][flag], bg="#DCF4FF")
    ...
    def get_tree(self, gender, age, weight):
        ...
        if TREE[0][gender][age][weight]:
            ...
            for i in range(3):
                ...
                vs_label = tk.Label(self, text='Проти', bg="#DCF4FF")
