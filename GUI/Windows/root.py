...
NavigationButton(master=btn_frame, text="Выход", root_win=window.root, command=program_exit).grid(row=0, column=0,
                                                                                          sticky="news")
...
battle_window = BattleWindow(master=work_space, root_win=RootWindow.root, background="#6C6C6C")
work_space.add(battle_window)
